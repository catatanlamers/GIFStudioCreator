package com.computika.gifstudiocreator.Adapter;
...
import com.computika.gifstudiocreator.Model.Data;
import com.computika.gifstudiocreator.Model.Fixed_height_still;
import com.computika.gifstudiocreator.Model.Picture;
import com.computika.gifstudiocreator.R;
import com.computika.gifstudiocreator.ShowGifActivity;
import com.computika.gifstudiocreator.Utility.BaseActivity;
import com.computika.gifstudiocreator.Utility.Constant;
    ...
    private class DownloadFile extends AsyncTask<String, String, File> {
        ...
        protected File doInBackground(String... all_tones) {
            ...
            try {
                ...
                String gifPath = rightNow.getTimeInMillis() + "GIFStudioCreator" + ".gif";
